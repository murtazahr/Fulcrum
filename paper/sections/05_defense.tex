...
uniform DP-SGD. Measured gap values are
$K_{\mathrm{uniform}} - K^\star$ at $\eta=1$ on Setting~C
($n=50$, $\Tmax=100$, $|B|=64$, $C=1.0$, $U=0.5$); the predicted
star asymptote is $an/U = 1.2207$.}
\label{tab:regimes}
\begin{tabular}{@{}lllc@{}}
\toprule
...
Cross-silo with heterogeneous $|\Dset_i|$ & No & Strong (\cf~Cor.~\ref{cor:influence}) & \PLACE{pending} \\
\bottomrule
\end{tabular}
