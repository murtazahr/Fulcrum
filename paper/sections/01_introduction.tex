...
\item Empirical evaluation on Fed-ISIC2019, Fed-Heart-Disease, and
  synthetic CIFAR-10 with parametric coupling, validating that the
  predicted privacy-bound gap matches measured attack lift across
  topologies (\S\ref{sec:experiments}).
\end{enumerate}
