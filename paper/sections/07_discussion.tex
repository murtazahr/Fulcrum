...
tighter conversion via Asoodeh et~al.~\cite{asoodeh2021variants} or
amplified RDP via Wang et~al.~\cite{wang2019subsampled} would shrink
the bound substantially under Poisson subsampling. This slack is
appropriate for a privacy guarantee. Tighter bounds are a follow-up
direction.
