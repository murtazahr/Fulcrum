...
\emph{neighbourhood-aggregated} updates rather than per-client ones; this
...
experiment (\S\ref{sec:experiments-sa}).
...
(ii)~prove a tight MI bound that decomposes into a controllable
mechanism term plus an uncontrollable prior-coupling floor; and
