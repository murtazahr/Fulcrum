...
The original Stage~3 hypothesis predicted that the combined adversary
$\Adv_2^{\text{full}}$ strictly dominates each single-channel
ablation. The empirical evidence in \S\ref{sec:experiments-channels}
qualifies that hypothesis on both settings examined:
...
regressor's combined feature set picks up noise the additional
