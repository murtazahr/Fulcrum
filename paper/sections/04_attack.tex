...
yields under DP-SGD across the four channel ablations, on three FL
...
no prior work isolates these channels per client. The attack also serves
as the empirical comparator against which we validate the predictive
power of the privacy bound proved in \S\ref{sec:defense}.
